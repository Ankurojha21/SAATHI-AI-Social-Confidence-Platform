...
const weekly = [18, 32, 55, 61, 38, 70, 31];
    ...
    <div className="saathi-dashboard pb-20">
      ...
      <section className="dash-activity-grid">
        <div className="old-card weekly-card">
          <div className="section-head"><div><h3>Weekly activity</h3><p>Your practice rhythm</p></div><span>4 day streak</span></div>
          <div className="bars">{weekly.map((h, i) => <div className="bar-col" key={i}><div className="bar" style={{height:`${h}px`}}/><small>{['M','T','W','T','F','S','S'][i]}</small></div>)}</div>
        </div>
